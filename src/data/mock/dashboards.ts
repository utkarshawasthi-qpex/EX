...
export const DRIVER_COMPARE_DASHBOARD_ID = 'dash_driver_variants_compare'

const DRIVER_COMPARE_CONFIG = {
  outcomeMetricId: 'marker_inclusion',
  outcomeLabel: 'Inclusion',
  driverMetricIds: [
    'marker_growth',
...
export function createDriverCompareDashboard(): Dashboard {
  return {
    id: DRIVER_COMPARE_DASHBOARD_ID,
    name: 'Driver Analysis — Variant Comparison',
    access: 'private',
    authorEmail: 'sarah.johnson@questionpro.com',
    createdAt: '2026-09-03T10:00:00Z',
    tabs: [
      {
        id: 'dash_driver_variants_compare_tab_1',
...
mockDashboards.push(createDriverCompareDashboard())

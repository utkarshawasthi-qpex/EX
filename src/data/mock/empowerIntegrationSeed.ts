    ...
    collaborators: [
      {
        userId: 'emp_008',
        tier: 'view_assign',
        invitedAt: timestampDaysAgo(10),
        invitedBy: 'emp_002',
        acceptedAt: timestampDaysAgo(9),
      },
    ],
    history: [{ at: timestampDaysAgo(14), event: 'Initiative created' }],
  },
  {
    id: 'init_ready_to_complete',
    title: 'Clarify career paths for IC engineers',
    description: 'All implementation tasks finished — ready to close the loop with the team.',
    goalId: 'goal_engagement',
    type: 'upstream',
    status: 'active',
    progress: 'on_track',
    ...
    tasks: [
      {
        id: 'task_rtc_1',
        text: 'Publish leveling rubric draft',
        ownerId: 'emp_002',
        dueDate: daysAgo(10),
        status: 'completed',
        completedAt: timestampDaysAgo(10),
        source: 'manual',
      },
      {
        id: 'task_rtc_2',
        text: 'Hold roadmap office hours',
        ownerId: 'emp_003',
        dueDate: daysAgo(3),
        status: 'completed',
        completedAt: timestampDaysAgo(3),
    ...
    surveyLink: {
      ...
      cycleLabel: '2026 Annual',
      scope: { kind: 'team', managerId: 'emp_002' },
      focus: { kind: 'marker', id: 'Growth', label: 'Growth' },
      baseline: { favorability: 52, respondentCount: 14, capturedAt: timestampDaysAgo(45), surveyStatus: 'closed' },
      latest: null,
    },
    history: [{ at: timestampDaysAgo(45), event: 'Initiative created' }],
  },
  {
    id: 'init_closed_with_feedback',
    title: 'Pilot flexible Friday afternoons',
    description: 'Completed experiment with optional deep-work blocks on Fridays.',
    ...
    tasks: [
      {
        id: 'task_fb_1',
        text: 'Survey team on Friday focus preferences',
        ownerId: 'emp_002',
        dueDate: daysAgo(60),
        status: 'completed',
        completedAt: timestampDaysAgo(58),
        source: 'manual',
      },
    ],
    provenance: null,
    surveyLink: {
      ...
      cycleLabel: 'Q3 2026',
      scope: { kind: 'team', managerId: 'emp_002' },
      focus: { kind: 'category', id: 'cat_wellbeing', label: 'Wellbeing' },
      baseline: { favorability: 65, respondentCount: 6, capturedAt: timestampDaysAgo(90), surveyStatus: 'live' },
      latest: null,
    },
    actionFeedback: {
      sentAt: timestampDaysAgo(55),
      responses: [
        { employeeId: 'emp_003', happened: 'yes', helped: 'yes', wouldRecommend: 'yes' },
        { employeeId: 'emp_004', happened: 'yes', helped: 'unsure', wouldRecommend: 'yes' },
        { employeeId: 'emp_005', happened: 'no', helped: 'no', wouldRecommend: 'unsure' },
      ],
    },
    history: [
      { at: timestampDaysAgo(90), event: 'Initiative created' },
      { at: timestampDaysAgo(55), event: 'Status set to completed; team feedback sent' },
    ],
  },
  {
